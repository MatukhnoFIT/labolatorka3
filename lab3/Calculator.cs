...
public class Calculator
{
    ...
    public void Count(Calculator calculator)
    {
        ...
        {
            Console.WriteLine("Ваш ответ: "+Plus(calculator));
        }
        else
        {
            if (calculator.Line.Contains("-"))
            {
                Console.WriteLine("Ваш ответ: " + Minus(calculator));
            }
            else
            {
                if (calculator.Line.Contains("*"))
                {
                    Console.WriteLine("Ваш ответ: " + Mult(calculator));
                }
                else
                {
                    Console.WriteLine("Вы ввели не верный оператор");
